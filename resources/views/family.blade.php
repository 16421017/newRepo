...
style="background-image: url({{ asset('img/trip/jalan.jpg') }});">
...
<section id="contact" class="contact">
    <div class="container">
          ...
          <div class="row">
            <div class="col-sm">
                <div class="card border" style="width: 18rem;">
                  <div class="card-body">
                    <h5 class="card-title">Package 5jt Wisata Pantai</h5>
                    <p class="card-title">selama 2 hari</p>
                    <p class="card-text">penginapan 5 Kamar</p>
        ...
        <div class="col-sm">
            <div class="card border" style="width: 18rem;">
              <div class="card-body">
                <h5 class="card-title">Paket 6jt Wisata Pantai</h5>
                <p class="card-title">selama 3 hari</p>
                <p class="card-text">penginapan 5 Kamar</p>
                <p class="card-text">Paket Makan pagi,siang,Malam</p>
                <p class="card-text">Kapal ke Pulau</p>
    ...
    <div class="col-sm">
        <div class="card border" style="width: 18rem;">
          <div class="card-body">
            <h5 class="card-title">Paket 7jt Wisata Pantai</h5>
    ...
    <div class="col-sm">
        <div class="card border" style="width: 18rem;">
          <div class="card-body">
            ...
            <p class="card-title">selama 2 hari</p>
            <p class="card-text">2 tenda </p>
            <p class="card-text">tour guide</p>
            <p class="card-text">Alat Pendakian</p>
            <p class="card-text">Paket di dapatkan setelah pembayaran</p>
...
<div class="col-sm">
    <div class="card border" style="width: 18rem;">
      <div class="card-body">
        <h5 class="card-title">Package 3jt Pendakian Gunung</h5>
        <p class="card-title">selama 3 hari</p>
        <p class="card-text">3 Tenda</p>
        <p class="card-text">Paket Makan pagi,siang,Malam dihari pertama</p>
        <p class="card-text">Tour Guide</p>
        <p class="card-text">Alat Pendakian</p>
        <p class="card-text">Dokumentasi</p>
        <p class="card-text">Paket di dapatkan setelah pembayaran</p>
